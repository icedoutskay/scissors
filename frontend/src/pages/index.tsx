	...
	const faqs = [
		{
			...
			answer: "A URL shortener is a tool that condenses long URLs into shorter, more manageable links. It makes lengthy web addresses shorter and easier to share, especially on platforms with character limits, such as social media.",
		},
		{
			id: 2,
			question: "How does a URL shortener work?",
			answer: "URL shorteners use a process called URL redirection, where a short link redirects users to the original, longer URL. When a user clicks on a shortened link, they're instantly redirected to the intended destination.",
		},
		{
			id: 3,
			question: "Are shortened links permanent?",
			answer: "Scissor generally aim for link permanence. However, some services have expiration settings where links may become inactive after a specified period. It's advisable to check the terms and conditions of the service for details on link longevity.",
		},
		{
			id: 4,
			question: "Can I edit or delete a shortened link?",
			answer: "Scissor do not allow users to edit or modify a created short link once it's generated. However, some services might offer account-based management where you can delete or deactivate links from your account dashboard.",
		},
		{
			id: 5,
			question: "What is a QR code?",
			answer: "A QR code, short for Quick Response code, is a two-dimensional barcode that stores information in a machine-readable format. It consists of black squares arranged on a white square grid, typically seen as a square image. QR codes can contain various types of data, such as text, URLs, contact information, or other forms of data.",
		},
		{
			id: 6,
			question: "How does a QR code work?",
			answer: "QR codes work by encoding information within the pattern of black squares and white spaces. When scanned using a smartphone camera or a QR code scanner app, the encoded data is quickly interpreted and processed, allowing the user to access the embedded information, such as a website link, contact details, or other digital content.",
		},
		{
			id: 7,
			question: "Are shortened links safe?",
			answer: "Scissor services prioritize user safety and security, shortened links can pose risks. Users should be cautious when clicking on shortened URLs from unknown or untrusted sources. Some services offer features like link preview to help users identify the destination before clicking.",
		},
		{
			id: 8,
			question: "Can I track statistics for shortened links?",
			answer: "Yes, Scissor provide analytics and tracking features. Users can view statistics like the number of clicks, geographic location of users, referral sources, and more. This data can be valuable for marketing, campaign tracking, or understanding user behavior.",
		},
		{
			id: 9,
			question: "Are there limitations on how many links I can shorten?",
			answer: "Scissor Don't have limitations on the number of links users can shorten, you can shorten urls as many as you want.",
		},
	];
			...
			<Dialog
				...
				<div className="w-full flex flex-col items-center gap-3">
					<p className="text-2xl">
						You may copy the link below and share it to your
						friends.
					</p>
